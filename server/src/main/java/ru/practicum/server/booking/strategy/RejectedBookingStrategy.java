...
public class RejectedBookingStrategy implements BookingFetchStateStrategy {

    private final BookingRepository repository;

    @Override
    public List<Booking> getBookings(long userId, Sort sort) {
        return repository.findAllByBooker_IdAndStatus(userId, BookingStatus.REJECTED, sort);
    }
